...
Centralized logging configuration for the entire PersonaPlex bot.
This module hijacks the root logger and third-party loggers to enforce a 
uniform, color-coded logging format across all components.

WHY: Because debugging a distributed AI system is impossible if 
Uvicorn, PyTorch, and Discord.py all vomit logs in different formats.
"""
import logging
import sys
import os
